...
public class MainGUIForm {
    ...
    private JLabel label_si_insert_input_values_info_1;
    private JLabel label_si_insert_input_values_info_2;
    private JLabel label_si_insert_input_values_info_3;
    private JLabel label_si_insert_input_values_info_4;
    private JLabel label_si_insert_input_values_info_5;
    private JLabel label_si_insert_input_values_info_6;
    private JLabel label_si_insert_input_values_info_7;
    private JLabel label_si_insert_input_values_info_8;
    private JLabel label_si_insert_input_values_info_9;
    private JLabel label_si_insert_input_values_info_10;
    private JLabel label_si_insert_input_values_info_11;
    ...
    //Główny INSERT
        ...
        public void panel_si_insert_input_values_init(String selectedTable) {
            ...
            switch (selectedTable) {
                case "Producent":
                    ...
                    label_si_insert_input_values_info_1 = new JLabel("VARCHAR NOT NULL");
                    label_si_insert_input_values_2 = new JLabel("nazwisko");
                    label_si_insert_input_values_info_2 = new JLabel("VARCHAR NOT NULL");
                    label_si_insert_input_values_3 = new JLabel("firma");
                    label_si_insert_input_values_info_3 = new JLabel("VARCHAR");
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_1);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_2);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_3);
                ...
                case "Klient":
                    ...
                    label_si_insert_input_values_info_3 = new JLabel("VARCHAR NOT NULL");
                    label_si_insert_input_values_4 = new JLabel("data_urodzenia");
                    label_si_insert_input_values_info_4 = new JLabel("DATE NOT NULL");
                    label_si_insert_input_values_5 = new JLabel("email");
                    label_si_insert_input_values_info_5 = new JLabel("VARCHAR NOT NULL");
                    textField_si_insert_input_values_1 = new JTextField();
                    textField_si_insert_input_values_2 = new JTextField();
                    textField_si_insert_input_values_3 = new JTextField();
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_4);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_5);
                ...
                case "Pracownik":
                    ...
                    label_si_insert_input_values_info_5 = new JLabel("INTEGER NOT NULL");
                    textField_si_insert_input_values_1 = new JTextField();
                    textField_si_insert_input_values_2 = new JTextField();
                    textField_si_insert_input_values_3 = new JTextField();
                    textField_si_insert_input_values_4 = new JTextField();
                ...
                case "Produkt":
                    ...
                    label_si_insert_input_values_info_1 = new JLabel("INTEGER NOT NULL");
                    label_si_insert_input_values_2 = new JLabel("producent_id");
                    label_si_insert_input_values_info_2 = new JLabel("INTEGER NOT NULL");
                    label_si_insert_input_values_3 = new JLabel("tematyka");
                    label_si_insert_input_values_info_3 = new JLabel("VARCHAR NOT NULL");
                    label_si_insert_input_values_4 = new JLabel("nazwa");
                    label_si_insert_input_values_info_4 = new JLabel("VARCHAR NOT NULL");
                    label_si_insert_input_values_5 = new JLabel("cena");
                    label_si_insert_input_values_info_5 = new JLabel("INTEGER NOT NULL");
                    label_si_insert_input_values_6 = new JLabel("rabat");
                    label_si_insert_input_values_info_6 = new JLabel("INTEGER DEFAULT 0");
                    label_si_insert_input_values_7 = new JLabel("wysokosc");
                    label_si_insert_input_values_info_7 = new JLabel("INTEGER NOT NULL");
                    label_si_insert_input_values_8 = new JLabel("szerokosc");
                    label_si_insert_input_values_info_8 = new JLabel("INTEGER NOT NULL");
                    label_si_insert_input_values_9 = new JLabel("ilosc_egzemplarzy");
                    label_si_insert_input_values_info_9 = new JLabel("INTEGER DEFAULT 100");
                    label_si_insert_input_values_10 = new JLabel("ocena");
                    label_si_insert_input_values_info_10 = new JLabel("FLOAT DEFAULT 0");
                    label_si_insert_input_values_11 = new JLabel("ilosc_ocen");
                    label_si_insert_input_values_info_11 = new JLabel("INTEGER DEFAULT 0");
                    textField_si_insert_input_values_1 = new JTextField();
                    textField_si_insert_input_values_2 = new JTextField();
                    textField_si_insert_input_values_3 = new JTextField();
                    textField_si_insert_input_values_4 = new JTextField();
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_6);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_7);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_8);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_9);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_10);
                    ...
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_11);
                ...
                case "Typ_produktu":
                    ...
                    label_si_insert_input_values_info_1 = new JLabel("VARCHAR DEFAULT 'plakat' NOT NULL");
                    textField_si_insert_input_values_1 = new JTextField();
                    panel_si_insert_input_values.add(label_si_insert_input_values_1);
                    panel_si_insert_input_values.add(label_si_insert_input_values_info_1);
                    panel_si_insert_input_values.add(textField_si_insert_input_values_1);
                ...
                case "Ocena":
                    ...
                    label_si_insert_input_values_info_3 = new JLabel("FLOAT NOT NULL");
                    textField_si_insert_input_values_1 = new JTextField();
                    textField_si_insert_input_values_2 = new JTextField();
                    textField_si_insert_input_values_3 = new JTextField();
                    panel_si_insert_input_values.add(label_si_insert_input_values_1);
                ...
                case "Zamowienie":
                    ...
                    label_si_insert_input_values_info_1 = new JLabel("INTEGER NOT NULL DEFAULT 1");
                    label_si_insert_input_values_2 = new JLabel("klient_id");
                    label_si_insert_input_values_info_2 = new JLabel("INTEGER NOT NULL");
                    label_si_insert_input_values_3 = new JLabel("data_zamowienia");
                    label_si_insert_input_values_info_3 = new JLabel("DATE NOT NULL");
                    label_si_insert_input_values_4 = new JLabel("data_zrealizowania");
                    label_si_insert_input_values_info_4 = new JLabel("DATE DEFAULT NULL");
                    textField_si_insert_input_values_1 = new JTextField();
                    textField_si_insert_input_values_2 = new JTextField();
                    textField_si_insert_input_values_3 = new JTextField();
                    textField_si_insert_input_values_4 = new JTextField();
                ...
                case "Zamowione_produkty":
                    ...
                    label_si_insert_input_values_info_3 = new JLabel("INTEGER NOT NULL");
                    textField_si_insert_input_values_1 = new JTextField();
                    textField_si_insert_input_values_2 = new JTextField();
                    textField_si_insert_input_values_3 = new JTextField();
                    panel_si_insert_input_values.add(label_si_insert_input_values_1);
                ...
                case "Dostawa":
                    ...
                    label_si_insert_input_values_info_2 = new JLabel("DATE NOT NULL");
                    label_si_insert_input_values_3 = new JLabel("data_realizacji");
                    label_si_insert_input_values_info_3 = new JLabel("DATE DEFAULT NULL");
                    textField_si_insert_input_values_1 = new JTextField();
                    textField_si_insert_input_values_2 = new JTextField();
                    textField_si_insert_input_values_3 = new JTextField();
                    panel_si_insert_input_values.add(label_si_insert_input_values_1);
        ...
        /**
         * Metoda label_si_insert_output_init() odpowiadająca za inicjalizację panelu label_si_insert_output
         * @param result - wynik zapytania
         */
        public void label_si_insert_output_init(Boolean result){
            if(result){
                label_si_insert_output.setText("INSERT wykonany pomyślnie");
            } else {
                label_si_insert_output.setText("Błąd wykonania INSERT");
            }
        }
